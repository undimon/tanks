...
export class Module {
    ...
    protected addModel(modelName: string, modelClass: typeof Model): void {
        this.mvc.registerModel(modelName, modelClass);
    }   

    protected addController(notificationName: string, controllerClass: typeof Controller, viewClass?: typeof View): void {
     ...
     */
    protected addScene(sceneNotification: string, controllersNotifications: string[]): void {
